      ...
      <section ref={containerRef}>
        ...
        >
          <div className="flex flex-col xl1440:w-1/2 gap-4 justify-center items-center m-auto text-center">
            <h1 className="text-main font-bold text-3xl xl1440:text-5xl leading-[3.5rem] w-10/12">
              Blog Racines
            </h1>
            ...
            <div className="xl1440:w-[70%] w-[90%] m-auto p-8 bg-white rounded-3xl my-6">
              <div className="flex justify-between gap-10 flex-col xl1440:flex-row">
                ...
                <div className="flex flex-col justify-between relative">
                  <h2 className="font-semibold text-xl xl1440:text-2xl xl1440:leading-8 text-main xl1440:pt-10">
                    Kinésithérapie pendant la grossesse : bienfaits,
                    indications et précautions
                  </h2>
                  <p className="text-[#6B7280] xl1440:text-lg text-base leading-7 mt-2 xl1440:pb-28 pb-4">
                    Pendant la grossesse, certaines douleurs et gênes peuvent
                    être accompagnées grâce à une prise en charge adaptée.
                    Découvrez quand consulter et comment se déroule une séance.
                  </p>
                  <span className="text-[#6b7280] pb-6">
                    3 septembre 2026
                  </span>
                  <Link
                    href="/blog/kinesitherapie-grossesse"
                    aria-label="Lire l’article sur la kinésithérapie pendant la grossesse"
                    className="absolute bottom-0 right-0 bg-main w-14 h-14 rounded-full flex justify-center items-center text-white hover:bg-second transition-colors duration-300"
                  >
